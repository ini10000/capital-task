  ...
  const [application, setApplication] = useState<IApplicationForm>({
    data: {
      ...
      attributes: {
        coverImage: "",
        personalInformation:
          personalInfoTemplate as IApplicationForm["data"]["attributes"]["personalInformation"],
        profile:
          profileTemplate as IApplicationForm["data"]["attributes"]["profile"],
        customisedQuestions:
          [] as IApplicationForm["data"]["attributes"]["customisedQuestions"],
      },
    },
  } as IApplicationForm);
  ...
  return (
    <main className="flex-1 relative py-8 md:py-10 z-0 overflow-y-auto">
      ...
      <section className="flex flex-col gap-16 p-5 md:mx-10 items-center md:max-w-2xl">
        ...
        <ExtraQues
          customisedQuestions={
            application?.data?.attributes?.customisedQuestions
          }
